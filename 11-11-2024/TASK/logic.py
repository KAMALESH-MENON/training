class Logic:
    ...
    def sort_by_location(self):
        return sorted(self.tasks, key=lambda x: x.location)

    def sort_by_priority(self):
        return sorted(self.tasks, key=lambda x: x.priority)

    def sort_by_name(self):
        return sorted(self.tasks, key=lambda x: x.task_name)

    def filter_by_location(self, location):
        return filter(lambda x: x.location == location, self.tasks)
